...
if __name__ == '__main__':
    ...
    filepath_string = "results_TAMU/Exp2RG/"
    ...
    k_max = np.ceil(size_of_ground_set/(size))
    k_min = np.ceil(size_of_ground_set/(size**3))
    number_of_tests = int(np.ceil(np.log(int(k_max/k_min))/np.log(2)))

    k_vals_vec = [int(k_min*pow(2, i)) for i in range(number_of_tests)]
    k_vals_vec.append(int(k_max))

    # k_vals_vec = [800, 1600, 3200, 6250]
    ...
    if(obj=="MCV"):
        ...
        experiment_string = 'MaxCov-ba100K'
    ...
    if(obj=="IFM"):
        ...
        experiment_string = 'InfMax-er100K'
    ...
    if(obj=="RVM"):
        ...
        experiment_string = 'RevMax-ws100K'
