    ...
    for ii, kk in enumerate(k_vals_vec):
        ...
        for trial in range(trials):
            ...
            if rank == p_root:
                ...
                dataset.to_csv(path_or_buf = filepath_string + experiment_string +'_exp3_'+ algostring +".csv", index=False)
...
if __name__ == '__main__':
    ...
    filepath_string = "experiment_results_output_data/Exp3/"
