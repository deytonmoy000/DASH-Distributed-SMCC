...
python3 plot_scripts/plot_util.py t 1 experiment_results_output_data/Exp2/${data}_exp2_DASH-8-4.csv experiment_results_output_data/Exp2/${data}_exp2_PGBHeuristic-8-4.csv
