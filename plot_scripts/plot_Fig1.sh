...
#IMAGESUMM
data='IMAGESUMM'
python3 plot_scripts/plot_util.py v 1 experiment_results_output_data/Exp1/${data}_exp1_RandGreedI-8-4.csv experiment_results_output_data/Exp1/${data}_exp1_BiCriteriaGreedy-8-4.csv experiment_results_output_data/Exp1/${data}_exp1_ParallelAlgoGreedy-8-4.csv experiment_results_output_data/Exp1/${data}_exp1_DD-8-4.csv experiment_results_output_data/Exp1/${data}_exp1_DASH-8-4.csv experiment_results_output_data/Exp1/${data}_exp1_TDASH-8-4.csv experiment_results_output_data/Exp1/${data}_exp1_GDASH-8-4.csv
