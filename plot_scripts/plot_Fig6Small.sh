...
python3 plot_scripts/plot_util.py t 1 experiment_results_output_data/Exp1/${data}_exp1_DASH-8-4.csv experiment_results_output_data/Exp1/${data}_exp1_PGB-8-4.csv
