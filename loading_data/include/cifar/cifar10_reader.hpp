...
void read_test(const std::string& folder, std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_cifar10_file(images, labels, "./cifar-10-batches-bin/test_batch.bin", limit, func);
}
...
void read_training(const std::string& folder, std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_cifar10_file(images, labels, "./cifar-10-batches-bin/data_batch_1.bin", limit, func);
    read_cifar10_file(images, labels, "./cifar-10-batches-bin/data_batch_2.bin", limit, func);
    read_cifar10_file(images, labels, "./cifar-10-batches-bin/data_batch_3.bin", limit, func);
    read_cifar10_file(images, labels, "./cifar-10-batches-bin/data_batch_4.bin", limit, func);
    read_cifar10_file(images, labels, "./cifar-10-batches-bin/data_batch_5.bin", limit, func);
}
...
void read_test(std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_test("./exp/exp-imgSumm/cifar-10-batches-bin", limit, images, labels, func);
}
...
void read_training(std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_training("./exp/exp-imgSumm/cifar-10-batches-bin", limit, images, labels, func);
}
...
void read_training_categorical(const std::string& folder, std::size_t limit, Images& images, Labels& labels) {
    read_cifar10_file_categorical(images, labels, "./cifar-10-batches-bin/data_batch_1.bin", limit, 0);
    read_cifar10_file_categorical(images, labels, "./cifar-10-batches-bin/data_batch_2.bin", limit, 10000);
    read_cifar10_file_categorical(images, labels, "./cifar-10-batches-bin/data_batch_3.bin", limit, 20000);
    read_cifar10_file_categorical(images, labels, "./cifar-10-batches-bin/data_batch_4.bin", limit, 30000);
    read_cifar10_file_categorical(images, labels, "./cifar-10-batches-bin/data_batch_5.bin", limit, 40000);
}
...
void read_test_categorical(const std::string& folder, std::size_t limit, Images& images, Labels& labels) {
    read_cifar10_file_categorical(images, labels, "./cifar-10-batches-bin/test_batch.bin", limit, 0);
    // read_cifar10_file_categorical(images, labels, "./cifar-10-batches-bin/test_batch.bin", limit, 0);
}
...
void read_training_categorical(std::size_t limit, Images& images, Labels& labels) {
    read_training_categorical("./exp/exp-imgSumm/cifar-10-batches-bin", limit, images, labels);
}
...
void read_test_categorical(std::size_t limit, Images& images, Labels& labels) {
    read_test_categorical("./exp/exp-imgSumm/cifar-10-batches-bin", limit, images, labels);
}
 ...
 * \return The dataset
 */
template <template <typename...> class Container = std::vector, template <typename...> class Sub = std::vector, typename Pixel = int, typename Label = int>
